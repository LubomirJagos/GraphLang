...
//                                                        
GraphLang.UserDefinedSymbol.UserDefined3 = GraphLang.UserDefinedNode.extend({            

   NAME: "GraphLang.UserDefinedSymbol.UserDefined3",
   ...
   init:function(attr, setter, getter)
   {
     ...
     var port;
     // in1
     port = this.createPort("input", new draw2d.layout.locator.XYRelPortLocator(0.05520833333335266, 24.13793103448289));
     port.setConnectionDirection(3);
     port.setBackgroundColor("#37B1DE");
     port.setName("in1");
     port.setMaxFanOut(20);
     // in2
     port = this.createPort("input", new draw2d.layout.locator.XYRelPortLocator(0.05520833333335266, 44.8533333333334));
     port.setConnectionDirection(3);
     port.setBackgroundColor("#37B1DE");
     port.setName("in2");
     port.setMaxFanOut(20);
     // in3
     port = this.createPort("input", new draw2d.layout.locator.XYRelPortLocator(0.05520833333335266, 85.3425287356323));
     port.setConnectionDirection(3);
     port.setBackgroundColor("#37B1DE");
     port.setName("in3");
     port.setMaxFanOut(20);
     // out1
     port = this.createPort("output", new draw2d.layout.locator.XYRelPortLocator(101.92187499999991, 50));
