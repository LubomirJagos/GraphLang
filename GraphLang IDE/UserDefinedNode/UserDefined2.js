...
GraphLangTestShape = GraphLang.UserDefinedNode.extend({            
   ...
   init:function(attr, setter, getter)
   {
     ...
     var port;
     // input0
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(2.380952380952381, 35.714285714285715));
     port.setConnectionDirection(undefined);
     port.setBackgroundColor("#37B1DE");
     port.setName("input0");
     port.setMaxFanOut(20);
     // input1
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(2.380952380952381, 69.04761904761905));
     port.setConnectionDirection(undefined);
     port.setBackgroundColor("#37B1DE");
     port.setName("input1");
     port.setMaxFanOut(20);
     // output0
     port = this.createPort("output", new draw2d.layout.locator.XYRelPortLocator(102.38095238095238, 52.38095238095238));
     port.setConnectionDirection(undefined);
     port.setBackgroundColor("#37B1DE");
