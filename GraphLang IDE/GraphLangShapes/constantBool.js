/**
 * @class GraphLang.Shapes.Basic.Constant.bool
 * @author Lubomir Jagos
 * @extend draw2d.shape.basic.Rectangle
 * @description Bool constant,  EXPERIMENTAL.
 */
GraphLang.Shapes.Basic.Constant.bool = draw2d.shape.basic.Rectangle.extend({

    NAME: "GraphLang.Shapes.Basic.Constant.bool",
    ...
    init:function(attr)
    {
      ...
      this.setBackgroundColor(color.getByName("bool"));
