 ...
 */
GraphLang.Shapes.Basic.Constant.float = draw2d.shape.basic.Rectangle.extend({

    NAME: "GraphLang.Shapes.Basic.Constant.float",
    ...
    init:function(attr)
    {
      ...
      this.setBackgroundColor(color.getByName("float"));
